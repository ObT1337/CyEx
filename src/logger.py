...
def get_logger(
    ...
    format: str = None,
    c_format: str = None,
    log_file: str = "CyEx.log",
    runtimes_files: str = "CyEx_runtimes.log",
) -> logging.Logger:
    """Initialize the CyEx Logger.

    Args:
        name (str, optional): Name of the Logger. Defaults to "CyEx".
        ...
        log_file (str, optional): Name of the log file. Defaults to "CyEx.log".
        runtimes_files (str, optional): Name of the runtimes file. Defaults to "CyEx_runtimes.log".
